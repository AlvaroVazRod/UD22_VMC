...
public class Modelo {
	...
	public Modelo(int id, String nombre, String apellido, String direccion, int dni, Date fecha) {
		this.id = id;
		this.nombre = nombre;
...
// Metodo para insertar datos en la tabla
	public void insertData(String db, String table_name, String nombre, String apellido, String direccion, int dni,
			Date fecha) {
		try {
